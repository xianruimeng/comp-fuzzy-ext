...
\left (U, \{j_{ij}\}, 1^{\ell (\kappa+\eta\log |\mathcal Z|)} \right)\right| \le \frac{q(q+1)}{2^\subsetEntropy} \le \ngl(n)\,.
\end{align}
\end{lemma}
