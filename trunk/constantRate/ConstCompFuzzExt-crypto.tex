...
Our constructions use simulation-secure obfuscation of digital lockers, which can be achieved by simple efficient constructions using a salted hash function or modular exponentiation under appropriate assumptions~\lnote{refs needed? especially for salted hash?}\bnote{the canetti 98 paper is okay for one time but we need reusability, the mod exp is bitanski canetti }
