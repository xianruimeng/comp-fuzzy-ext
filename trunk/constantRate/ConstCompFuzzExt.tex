...
\begin{proof}
Define $\mu = -\log(1-t'/(2\ell))/2 = \Theta(1)$ and note that $t \leq \mu(\gamma - \eta)/\eta$.
Let
...
&= \left(1-\frac{\mu}{\eta}\right)^{\eta} =\left( \left(1-\frac{\mu}{\eta}\right)^{\eta/\mu}\right)^\mu\geq \frac{1}{4}^\mu\\
