...
All of our constructions support more errors than entropy by tolerating errors in a large alphabet and performing error correction over a different smaller alphabet.  This approach seems limited to larger alphabets~(all of our constructions require a super-constant size alphabet).  Supporting distributions with more errors than entropy over small alphabets is an important open problem.
