...
We provide the first constructions of fuzzy extractors that can be used for a large class of distributions with $\Huse\le 0$ over the Hamming metric on $\mathcal{Z}^\ell$ for an alphabet $\mathcal{Z}$. 
