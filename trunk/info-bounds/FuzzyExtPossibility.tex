...
We can't work directly on the Hamming distance over a large alphabet~(as we did for secure sketches). \lnote{it would be good to explain why not}  We embed this larger space to the binary Hamming metric.
