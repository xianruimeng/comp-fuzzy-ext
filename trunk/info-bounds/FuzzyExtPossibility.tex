...
\begin{align*}
\tilde{H}_0(V | \sketch(V), Z) &\le \tilde{H}_0(V | \sketch(V) )- \log H_0(Z | V)\\
...
&\le \Theta(1)
\end{align*}
 Where the last line follows for $t\ge 4$.  The fourth line follows from the third as long as $|\mathbb{F}|????$\bnote{fix this}\bnote{add more to this}
 \end{proof}
