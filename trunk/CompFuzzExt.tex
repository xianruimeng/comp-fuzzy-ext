...
\xnote{change it to \class{Decode()}?}
...
\xnote{Approximating to decision version of GapSVP is to decision problem of SVP by creating the `gap'... don't think it's confusing...}
