...
We consider this notion to be a natural notion for a computational sketch as it can be extracted from using a reconstructive extractor~(as shown by \cite[Lemma 6]{DBLP:conf/eurocrypt/HsiaoLR07}).
%\footnote{See~\cite{barak-computational} for the definition of reconstruction extractor.}.   show that unpredictability entropy can be e.
