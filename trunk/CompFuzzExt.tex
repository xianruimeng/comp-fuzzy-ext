...
sketches are still subject to the same lower bounds. Specifically, we consider
two computational relaxations of the information-theoretic security requirement of secure sketches, using conditional HILL entropy and unpredictability entropy. For both cases we show  that computational secure sketches cannot outperform information-theoretic ones in the case of high-entropy Hamming metric sources.
...
\lnote{what's up with this section/subsection thing?}
