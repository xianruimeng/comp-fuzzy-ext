...
Let $\mathcal{I}$ be the set of all indices in \defref{def:block guessable}.  Then $\Hav(C | C_{\mathcal{I}^c}) \geq |C| - \beta$.  We now show that codewords that differ only positions of $\mathcal{I}$ are indistinguishable.
\begin{lemma}
