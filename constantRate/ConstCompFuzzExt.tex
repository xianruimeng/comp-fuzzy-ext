...
Let $C$ be a subset of $\{0,1\}^\ell$ with a uniform distribution, and let $\mathcal{I}\subset \{1,\dots,\ell\}$.  Then $\Hav(C | C_{\mathcal{I}^c}) = \log |C| - |\mathcal{I}^c|$.
\end{claim}
