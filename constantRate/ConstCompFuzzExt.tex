...
Our constructions are computationally secure.  Known techniques for proving security of information-theoretic  fuzzy extractors work for all distributions of a given entropy, and thus cannot be used with $\Huse\le 0$ (because then they would prove security for all distributions with $\Huse \le 0$, which we know is impossible.) \bnote{something about the parenthetical statement I don't like}
