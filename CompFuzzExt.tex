...
We are interested in the case where $\rank(\vS) = \alpha$, and it suffices to show that $\D'$ can properly prepares a random instance in this case. We show this in the following three claims: 
\begin{enumerate}
