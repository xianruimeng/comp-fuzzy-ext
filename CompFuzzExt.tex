...
\end{itemize}
\textbf{Keywords} Fuzzy extractors, secure sketches, key derivation, Learning with Errors, noise tolerance, error-correcting codes, computational entropy, randomness extractors.
\end{abstract}
...
\thref{thm:lossless secure extractor log} shows that a computational fuzzy extractor can be built without incurring any entropy loss.  This is essentially due to $\vA X+W$ looking like a uniformly random point and providing no information about either $X$ or $W$.  
