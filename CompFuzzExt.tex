...
We begin by recalling a few basic definitions.  For a random variable $X = X_1,..., X_n$ where each $X_i$ is over some $\chi$, we denote by $X_{1,..., k} = X_1,..., X_k$.  The {\em min-entropy} of $X$ is $\Hoo(X) = -\log(\max_x \Pr[X=x])$, 
