...
A pair of randomized procedures $(\sketch, \rec)$ is a $(\mathcal{M},m, \tilde{m}, \epsilon,  t)$-\emph{computational secure sketch} is a pair of randomized procedures, sketch (\sketch) and recover (\rec), with the following properties:
\begin{enumerate}
