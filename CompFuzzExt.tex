...
\begin{align*}
\va_i \vx^* + e_i^* &= \sum_{j=1}^{n+\alpha} \vA_{ij} x^*_j + e_i^*\\
& = \sum_{j=1}^{n+\alpha}\left((\vA^*_{ij}+\sum_{k=1}^\alpha \gamma_{i, k} \vA^*_{(m+k)j})x^*_j\right) + e_i^*\\
& = \sum_{j=1}^{n+\alpha}\vA^*_{ij}x^*_j + e_i^* + \sum_{j=1}^{n+\alpha}\sum_{k=1}^\alpha \gamma_{i, k} \vA^*_{(m+k)j}x^*_j \\
& = \sum_{j=1}^{n+\alpha}\vA^*_{ij}x^*_j + e_i^* + \sum_{k=1}^\alpha  \gamma_{i, k} \sum_{j=1}^{n+\alpha} \vA^*_{(m+k)j}x^*_j\\
& = \sum_{j=1}^{n+\alpha}\vA^*_{ij}x^*_j + e_i^* + \sum_{k=1}^\alpha \gamma_{i, k} \left(\left( \sum_{j=1}^n \vR_{i, j}x_j^* \right) + x_{n+k}^*\right)\\
& = \sum_{j=1}^{n+\alpha}\vA^*_{ij}x^*_j + e_i^* + \sum_{k=1}^\alpha\gamma_{i, k} b_{m+k}^*\\
