...
n_0&< n - k\\
t&\leq d\log n\left(\frac{m}{n}-2\right)\\
m \log 2n^{1/2+\sigma}m &= k \log n^f
\end{align*}
...
f &= \frac{m}{k}\frac{\log 2n^{1/2+\sigma} m}{\log n}
\end{align*}
...
f &= \frac{m}{k}\frac{\log 2n^{1/2+\sigma}m}{\log n} = \frac{g(c+2d)}{d}\frac{\log \frac{2(c+2d)}{d} n^{3/2+\sigma}}{\log n}
\end{align*}
...
\begin{align*}
m &= \frac{(c+2d)n}{d}\\
q & = n^f = n^{\frac{m}{n}\frac{\log 2n^{1/2+\sigma}m}{\log n}} = \poly(n)\\
...
n_0&< n/3 -  \log n\\
m &= \frac{(c+2d)n \log n}{d \log n} = \frac{(c+2d)n}{d}\\
f &= \frac{m}{k}\frac{\log 2n^{1/2+\sigma}m}{\log n} = \left(\frac{3(c+2d)}{d}\right)\frac{\log \frac{2(c+2d)}{d} n^{3/2+\sigma}}{\log n}
\end{align*}
