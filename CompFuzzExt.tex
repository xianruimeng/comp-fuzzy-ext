...
\bnote{This needs to be consistent with the notation above.  Should be $W, S$ for original and $X, Y$ for indistinguishable distribution.}
\begin{definition}
