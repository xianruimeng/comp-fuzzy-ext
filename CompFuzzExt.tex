...
As before we arbitrarily set $\sigma = 1/2$.  Also, if $c<d$ then we get efficient decoding and $\rho = o(1)$ satisfying the condition of \lemref{lem:uniform LWE decision}.
