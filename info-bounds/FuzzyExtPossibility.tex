...
We now show that the fuzzy min-entropy conditioned on the level information is proportional to $\beta_{t, i}$.  Let $I$ be the random variable of the level information.
\begin{claim}
$\Hoo(W | I=i ) -\log \beta_{t, i} \ge \Hfuzz(W | I =i ) \ge \Hoo(W | I =i ) -\log \beta_{t, i}-1$.
\end{claim}
\begin{proof}
We show the left inequality first.
\begin{align*}
